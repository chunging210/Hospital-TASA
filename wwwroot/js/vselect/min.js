...
const { openBlock: a, createElementBlock: h, createElementVNode: u, resolveDirective: K, normalizeClass: A, renderSlot: r, normalizeProps: d, guardReactiveProps: c, Fragment: B, renderList: L, createTextVNode: v, toDisplayString: D, createBlock: b, resolveDynamicComponent: _, createCommentVNode: O, mergeProps: k, toHandlers: j, withDirectives: w, vShow: P, createVNode: $, Transition: R, withCtx: z, withModifiers: F } = Vue;
const U = {
    props: {
        autoscroll: {
            type: Boolean,
